  ...
  <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
    ...
    <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
      <div class="max-w-lg mx-auto lg:max-w-none">
        <form wire:submit.prevent="submitForm" action="/contact" method="POST" class="flex flex-col gap-4">
          @csrf
...
{{-- <!-- container -->
    <div class="flex h-screen justify-center items-center bg-slate-700">
      <!-- card -->
      <!-- flex container -->
      <div class="flex flex-col md:flex-row bg-slate-800 rounded-t-2xl overflow-hidden md:rounded-l-3xl md:p-2">
        <!-- image -->
        <img
          class="h-80 transform transition duration-100 ease-out hover:scale-105 md:rounded-l-3xl md:hover:scale-125 md:h-64"
          src="/img/image.jpg" alt="salt">
        <!-- content -->
        <div class="p-6 md:px-12">
          <h2 class="text-slate-100 text-xl text-center my-4 font-bold md:text-left">
            Get diet and fitness tips in your inbox
          </h2>
          <p class="m-4 text-xs text-center text-slate-400 max-w-xs leading-5 tracking-wide md:text-left">
            Eat better and exercise better. Sign up for the Diet & Fitness
            newsletter.
          </p>

          <!-- form -->
          <div class="flex flex-col md:flex-row mt-12 gap-4">
            <input
              class="py-2 px-6 rounded text-white placeholder:text-center focus:outline-none bg-slate-600 md:placeholder:text-left"
              placeholder="Enter Email" type="text">
            <button class="text-white text-sm  bg-lime-600 py-2 px-6 rounded-md md:text-base">Subscribe</button>
          </div>
        </div>
      </div>
    </div> --}}
